    ...
    <>
      <OutsideClickHandler onOutsideClick={handleClickOutside}>
        <div className="relative hidden md:inline-block">
          ...
          >
            <Image
              className="object-cover object-center w-10 h-10 rounded-full  border border-secondary p-[2px]"
            ...
            <span
              className={`duration-100 transform ${
                isOpen ? "-scale-y-100" : "" // Conditional class application for animation
              }`}
            >
              <svg
                width="20"
          ...
          {isOpen && (
            <div
              className="absolute right-0 top-12 z-10 w-48 bg-background shadow-md rounded-md py-2"
            ...
            >
              ...
              {userRole && userRole != "USER" && (
                <Link
                  href="/admin"
                  className="block px-4 py-2 hover:bg-background2 "
                  onClick={handleClickOutside}
                >
              ...
              <div
                className="block px-4 py-2 hover:bg-red-500 cursor-pointer"
                onClick={() => {
                  logOutAction();
                }}
              >
...
{/* ***************************************************************************** */}
      <div className="inline-block md:hidden ">
        ...
        {userRole && userRole != "USER" && (
          <Link
            href="/admin"
            className="  rounded  md:hover:bg-transparent md:border-0 hover:text-background2 md:p-0"
            onClick={onClick}
          >
            <span className="flex items-center gap-2">
              <svg
        ...
        <Link
          ...
          }  rounded  md:hover:bg-transparent md:border-0 hover:text-background2 md:p-0 `}
          onClick={onClick}
        >
          <span className="flex items-center gap-2">
            <svg
        ...
        <Link
          href="/#settings"
          className="py-2 px-3  rounded  md:hover:bg-transparent md:border-0 hover:text-background2 md:p-0 "
          onClick={onClick}
        >
          <span className="flex items-center gap-2">
            <svg
        ...
        <div
          className=" rounded  md:hover:bg-transparent md:border-0 hover:text-red-500 cursor-pointer"
          onClick={() => {
            onClick();
            // logOutAction();
          }}
