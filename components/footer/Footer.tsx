...
function Footer() {
  return (
      <section className="py-6 bg-gradient-to-r from-[#5d358b] via-[#56358c] to-[#63358d]">
        <div className="container">
          <div className="text-center xl:flex xl:items-center xl:justify-between xl:text-left">
            <div className="xl:flex xl:items-center xl:justify-start">
              <Link href="/" className="flex items-center gap-2 font-mono justify-center">
